 ...
 ***************************************************/
#define VL53L1__PORT hi2c3	// that's the I2C port connected to VI53L1X
#define VL53L1__ADDR (0x29 << 1)	// the I2C chip address
...
#define VL53L1__LOWER_THRESHOLD	(1000)		// (mm) lower window limit. For WINDOW_MODE = 0, 2, 3
...
#define I2C_COMM_TIMEOUT			50   	// ms timeout for the I2C communication
